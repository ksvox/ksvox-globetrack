...
function getFallbackTracks(countryCode, limit = 10) {
    ...
    const TRENDING_GLOBAL_2026 = [
        ...
        { title: 'Not Like Us', artist: 'Kendrick Lamar', album: 'Not Like Us', img: 'https://i.scdn.co/image/ab67616d0000b2731ea0c62b2339cbf493a999ad' },
        { title: '晩餐歌', artist: 'tuki.', album: '晩餐歌', img: 'https://i.scdn.co/image/ab67616d0000b27339d332d733475fb14db0fb1c' },
        { title: 'Die With A Smile', artist: 'Lady Gaga & Bruno Mars', album: 'Die With A Smile', img: 'https://i.scdn.co/image/ab67616d0000b27382211794174828f7311100f9' },
        { title: 'Taste', artist: 'Sabrina Carpenter', album: 'Short n\' Sweet', img: 'https://i.scdn.co/image/ab67616d0000b273fd8d7aeeed7e3e29f8f4165d' },
        { title: '幾億光年', artist: 'Omoinotake', album: '幾億光年', img: 'https://i.scdn.co/image/ab67616d0000b2733e8ca773d579b2a758782d73' }
    ];
    ...
    for (let i = 0; i < limit; i++) {
        if (i < base.length) {
            ...
            const sample = TRENDING_GLOBAL_2026[i % TRENDING_GLOBAL_2026.length];
            const num = i + 1;
            results.push({
                rank: num,
                title: `${sample.title} (${countryCode} Edition)`,
                artist: sample.artist,
                album: sample.album,
                img: sample.img,
                previewUrl: null,
                url: `https://open.spotify.com/search/${encodeURIComponent(sample.title)}`
            });
        }
    }
    return results;
